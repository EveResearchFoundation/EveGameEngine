...
module Shader =
    ...
    /// <summary>
    /// Sets the corresponding vec4 using the shader provided
    /// </summary>
    /// <param name="name">The name of the vec4 uniform in the shader</param>
    /// <param name="value">The new vec4 value</param>
    let setVec4 name (value:Vec4) (ShaderProgram(p) as program) = 
        let loc = getUniformLocation program name
        useProgram program
    ...
    /// <param name="name">The name of the vec4 uniform in the shader</param>
    /// <param name="value">The new vec4 value</param>
    let setFloat32 name (value:float32) (ShaderProgram(p) as program) = 
        let loc = getUniformLocation program name
        useProgram program
